...
main_menu() {
    while true; do
        ...
        echo -e "  • ${BLUE}Iran→Kharej:${NC} ${GREEN}iran-1, iran-2...${NC} (172.16.x.x)"
        echo -e "  • ${CYAN}Kharej→Kharej:${NC} ${GREEN}kharej-1, kharej-2...${NC} (172.17.x.x)"
        echo ""
        echo -e "${YELLOW}Example Setup (Your Scenario):${NC}"
        echo -e "  ${BLUE}Iran1${NC} → ${CYAN}Kharej-Waset1${NC} → ${MAGENTA}Kharej-Main${NC}"
        echo -e "  ${BLUE}Iran2${NC} → ${CYAN}Kharej-Waset2${NC} → ${MAGENTA}Kharej-Main${NC}"
        echo ""
